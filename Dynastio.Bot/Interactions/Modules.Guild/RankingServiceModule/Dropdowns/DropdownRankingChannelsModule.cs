...
namespace Dynastio.Bot.Interactions.Modules.Guild.Buttons
{
    ...
    /// </summary>
    public class DropdownRankingChannelsModule : MenuModulesBase, IMenuComponentRule
    {
        // -----------------------------------------------------------------------------------
        // SECTION: Constants
        // -----------------------------------------------------------------------------------
        ...
        /// </summary>
        public const string InteractionIdBase = "interactions.guild.dropdown.guildsetuprankingmodule.rankingchannels";
        ...
        {
            var defaultChannels = module.BotGuild.RankingSettings.AllowedXpChannelIds.Select(a => new SelectMenuDefaultValue(a, SelectDefaultValueType.Channel)).ToList();
        ...
        public async Task ExecuteAsync()
        {
            ...
            Context.BotGuild.RankingSettings.AllowedXpChannelIds = data.Values
