...
namespace Dynastio.Bot.Interactions.Modules.Guild.Buttons
{
    ...
    /// </summary>
    public class ButtonBadgePrefixModule : MenuModulesBase, IMenuComponentRule
    {
        // -----------------------------------------------------------------------------------
        // SECTION: Constants
        // -----------------------------------------------------------------------------------
        ...
        /// </summary>
        public const string InteractionIdBase = "interactions.guild.buttons.guildetupBadgeSyncerModule.prefix";
        ...
        public async Task ExecuteAsync(string trigger = "")
        {
            ...
            {
                await menu.RespondAsync("Prefix most ends with <: > examples:  <badge: > <item: > <text: >", ephemeral: true);
                return;
            }
            else
            {
            ...
            BotGuild.UpdateBadgeSettings(a => a.Prefix = data);
